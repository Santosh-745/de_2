<?php
    ...
    // if(!isset($_SESSION['faculty_loggedin']) || $_SESSION['faculty_loggedin'] != true){
    ...
    $iab_data = $conn->prepare("SELECT * FROM users where email = ? ");
    $iab_data->bindParam(1, $user);
    $iab_data->execute();
    $data = $iab_data->fetch(PDO::FETCH_ASSOC);
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
			  <ul class="navbar-nav">
				...
				<li class="nav-item">
				  <a class="nav-link" href="query.php?professionals=<?php echo $professionals?>">Queries</a>
				</li>
