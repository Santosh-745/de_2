...
<html lang="en">
  ...
  <div class="header">
		<h2>
			Queries related Your Professional Field of Work
		</h2>
	</div>
	<table class="table">
		<thead class="thead-dark">
		  <tr>
            ...
            <th scope="col">Add Solution</th>
		  </tr>
		</thead>
		<tbody>
  <?php
        $category = $_GET['professionals'];
        $iab_data = $conn->prepare("SELECT * FROM queries where category=? ");
        ...
        while ($rowdata = $iab_data->fetch(PDO::FETCH_ASSOC)) { ?>
          <tr>  
            ...
            <td><a href="add_steps.php"><button class="btn btn-primary">SOLVE</button> </a></td>
          </tr>
  <?php  }  ?>
      </tbody>
      </table>
